  ...
  return (
    <div className="flex flex-col items-center justify-center text-center min-h-screen bg-[#1A1A1A] px-4">
      ...
      <section className="mb-16 py-10">
        ...
        <p className="text-[#E5E5E5] max-w-xl mb-10 text-center mx-auto">
          Passionné par la création de sites web modernes, performants et d'applications mobiles intuitives.
        </p>

        <Link
          to="/about"
          className="bg-green-400 hover:bg-green-500 text-[#1A1A1A] font-semibold py-3 px-6 rounded-lg transition duration-300"
        >
      ...
      <section className="mb-16 py-10 bg-[#1A1A1A]">
        <h2 className="text-3xl font-semibold text-green-400 mb-4">Mes Projets</h2>
      ...
      <section className="py-10">
        <h2 className="text-3xl font-semibold text-green-400 mb-4">Contactez-moi</h2>
        <p className="text-[#E5E5E5] max-w-xl mb-8">
