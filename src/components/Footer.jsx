...
function Footer() {
  return (
    <footer className="bg-black text-gray-400 py-4 mt-9 relative border-t border-gray-800">
      <div className="absolute inset-0 bg-gradient-to-t from-green-400/10 to-transparent opacity-30"></div>

      <div className="relative max-w-7xl mx-auto py-4 px-6 flex flex-col md:flex-row justify-between items-center md:space-y-0 space-y-4">
        ...
        {/* Copyright */}
        <p className="text-center text-sm md:mb-0">
